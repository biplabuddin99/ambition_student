    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-4 col-10 logo-sec">
          <a href="{{route('front')}}"><img src="{{asset('uploads/settings/header_logo/'.$setting?->header_logo)}}" alt="" class="mw-100" height="100px"  /></a>
        </div>
    ...
    <div class="footer">
      <div class="container-fluid px-lg-5">
        <div class="footer-logo">
          {{-- <img width="200px" height="100px" src="{{asset('uploads/settings/footer_logo/'.$setting?->footer_logo)}}" alt="" /> --}}
        </div>
        <div class="row footer-nav">
          ...
          <div class="col-sm-8 col-lg-8 col-md-8 justify-content-end">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3747019.738999415!2d86.26565536942755!3d23.489341999116288!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa560b2726f81c859%3A0x3837950271987f76!2sAmbition%20Student%20Consultancy%20bd!5e0!3m2!1sen!2sbd!4v1727413788346!5m2!1sen!2sbd"
              width="700"
              height="293"
