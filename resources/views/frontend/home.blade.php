                    ...
                    @forelse ($vNotice as $notic)
                      @if ($notic->image != '')
                        <div class="carousel-item ">
                          ...
                          <p style="font-size: 20px; color:rgb(0, 68, 255); margin-top:6px; text-align:center; ">{{$notic->image_caption}}</p>
                        </div>
                      @else
                      @endif
                    @empty
                ...
                <div class="carousel-inner n-item-center notice-carousel shadow text-center">
                  @forelse ($vNotice as $v)
                    ...
                    <div class="carousel-item active">
                      ...
                      <p style="font-size: 14px; color:rgb(0, 89, 255); margin-top:2px; text-align:center;">{{$v->video_caption}}</p>
                    </div>
                    @else
                    @endif
                  @empty
                  ...
                  @forelse ($vNotice as $notic)
                    ...
                    <div class="carousel-item ">
                      <img src="{{asset('uploads/video_notice/'.$notic->image)}}" class="d-block w-100 notice-img" alt="..."/>
                      <p style="font-size: 14px; color:rgb(0, 68, 255); margin-top:2px; text-align:center; ">{{$notic->image_caption}}</p>
                    </div>
                    @else
                    @endif
                  @empty
